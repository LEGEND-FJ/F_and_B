                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Successful Purchases
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            $('#messageForm')[0].reset();
                            $('#sendMessageModal').modal('hide'); // Close modal
                            fetchMessages(); // Assuming this function exists to refresh the message list
                        } else {
                            Swal.fire({
                                icon: 'error',
                                title: 'Error',
