...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Add.php">My Products</a>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>Go To Landing Page!</strong></p>
                <a class="btn btn-success btn-sm" href="index.php">Let's go!</a>
            </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                if (isset($_POST['upload'])) {
                    ...
                    if ($check !== false) {
                        ...
                        if (move_uploaded_file($_FILES['product_image']['tmp_name'], $upload_file)) {
                            $sql = "INSERT INTO new_products (product_name, product_photo, quantity, price, posted_user, date_created) VALUES ('$product_name', '$upload_file',   '$quantity', '$price', '$posted_user', '$date_created')";
                ...
                $result = $conn->query("SELECT * FROM new_products");
                ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="d-flex flex-column h-100">
                                                        <h2 class="font-weight-bolder mb-0">Upload Product</h2>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><img class="img-fluid" style="width: 20%; height: auto;" src="<?php echo $row['product_photo'] ?>"></td>
                                            <td><?php echo $row['quantity'] ?></td>
                                            <td><?php echo $row['price'] ?></td>
                                            <td><?php echo $row['posted_user'] ?></td>
                        ...
                        if (data.length > 0) {
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div class="font-weight-bold">
                                    <div class="text-truncate">${message.sender}</div>
                                    <div class="small text-gray-500">${message.content} · ${message.created_at}</div>
                                </div>
                            </a>
                        `);
                            });
                        } else {
                            messageContainer.append('<div class="dropdown-item text-center">No new messages</div>');
                        }

                        $('#messageCounter').text(data.length);
                    },
    ...
    <!-- Page level plugins -->
    <script src="vendor12/chart.js/Chart.min.js"></script>
